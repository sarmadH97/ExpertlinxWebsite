      ...
      const ctx = gsap.context(() => {
        ...
        mm.add("(min-width: 1024px) and (min-height: 700px)", () => {
          ...
          hero
            ...
            .to("[data-hero-line='one']", { xPercent: -16, scale: 1.09, opacity: .2, duration: .7 }, .72)
            .to("[data-hero-line='two']", { xPercent: 17, scale: 1.08, opacity: .16, duration: .7 }, .76)
            .to("[data-hero-line='three']", { xPercent: -8, scale: 1.1, opacity: .18, duration: .7 }, .8)
